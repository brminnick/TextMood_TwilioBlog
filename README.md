...
12. In the **Solution Explorer**, right-click on the **TextMood** project -> **Reload Project**
    - If a confirmation popup appears, select **OK**

13. In the **Solution Explorer**, double-click on **Function1.cs**
14. Copy the below code into the **Function1.cs** window, overwriting all existing code which was auto-generated by the template
...
15. In the **Function1.cs** window, for `_textSentimentAPIKey`, replace `Your API Key` with the Key from the TextAnalytics Cognitive Service resource created earlier
16. In the **Function1.cs** window, for `_cognitiveServicesEndpoint`, replace `Your Cognitive Services Endpoint` with the Endpoint from the TextAnalytics Cognitive Service resource created earlier
